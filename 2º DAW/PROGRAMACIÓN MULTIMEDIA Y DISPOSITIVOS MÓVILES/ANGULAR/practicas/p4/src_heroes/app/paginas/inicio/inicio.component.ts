...
export class InicioComponent {
  lista: IHeroe[] = [];
  heroeSeleccionado: string | null = null; // Propiedad para almacenar el héroe seleccionado

  constructor(/*private router: Router*/) { // LO USAREMOS MAS ADELANTE CON EL METODO DE DEBAJO
    this.lista = [
      {
        nombre: 'Superman',
  ...
  verHeroe(nombre: string): void {
    // Si el héroe ya está seleccionado, al hacer clic lo deseleccionamos
    this.heroeSeleccionado = this.heroeSeleccionado == nombre ? null : nombre;
  }
