...
public class EjemplosFiles {
	...
	public static void main(String[] args) {
		...
		/* Borra el fihero pero si no existe no lanza excepci�n. Si tienes varios hilos borrando ficheros 
		...
		// Copia origen.txt en destino.txt, si el fichero existe salta la excepci�n FileAlreadyExists
